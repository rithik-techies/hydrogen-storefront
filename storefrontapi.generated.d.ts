...
export type HomeStoreCollectionsQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
}>;

export type HomeStoreCollectionsQuery = {
  collections: {
    nodes: Array<
...
export type LatestBlogsQueryVariables = StorefrontAPI.Exact<{
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  blogHandle: StorefrontAPI.Scalars['String']['input'];
}>;

export type LatestBlogsQuery = {
...
export type ArticleItemFragment = Pick<
  StorefrontAPI.Article,
  'contentHtml' | 'handle' | 'id' | 'publishedAt' | 'title' | 'content' | 'tags'
> & {
...
export type ExpertChosenProductsQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ExpertChosenProductsQuery = {
  shop: {
  ...
  blog?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Blog, 'handle'> & {
      articleByHandle?: StorefrontAPI.Maybe<
        Pick<
          StorefrontAPI.Article,
          'handle' | 'title' | 'tags' | 'contentHtml' | 'publishedAt'
        > & {
          author?: StorefrontAPI.Maybe<
            Pick<StorefrontAPI.ArticleAuthor, 'name'>
          >;
...
export type CollectionsPageQueryQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  endCursor?: StorefrontAPI.InputMaybe<
    StorefrontAPI.Scalars['String']['input']
  >;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment Collection on Collection {\n    id\n    title\n    handle\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n    products(first: 250) {\n      nodes {\n        id\n      }\n    }   \n  }\n\n  query HomeStoreCollections($first: Int!) {\n    collections(first: $first, sortKey: TITLE) {\n      nodes {\n        ...Collection\n      }\n    }\n  }\n': {
    return: HomeStoreCollectionsQuery;
    variables: HomeStoreCollectionsQueryVariables;
  };
  ...
  '#graphql\n  query LatestBlogs(\n    $language: LanguageCode\n    $blogHandle: String!\n  ) @inContext(language: $language) {\n    blog(handle: $blogHandle) {\n      title\n      handle\n      seo {\n        title\n        description\n      }\n      articles(first: 4) {\n        nodes {\n          ...ArticleItem\n        }\n        pageInfo {\n          hasPreviousPage\n          hasNextPage\n          startCursor\n          endCursor\n        }\n      }\n    }\n  }\n\n  fragment ArticleItem on Article {\n    author: authorV2 {\n      name\n    }\n    contentHtml\n    handle\n    id\n    image {\n      id\n      altText\n      url\n      width\n      height\n    }\n    publishedAt\n    title\n    content\n    tags\n    blog {\n      handle\n    }\n  }\n': {
    return: LatestBlogsQuery;
    variables: LatestBlogsQueryVariables;
  };
  ...
  '#graphql\n  query ExpertChosenProducts($first: Int!, $country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    shop {\n      metafield(namespace: "custom", key: "product_chosen_by_expert") {\n        references(first: $first) {\n          nodes {\n            ... on Product {\n              id\n              title\n              handle\n              tags\n              description\n              availableForSale\n              featuredImage {\n                id\n                url\n                altText\n                width\n                height\n              }\n              priceRange {\n                minVariantPrice {\n                  amount\n                  currencyCode\n                }\n                maxVariantPrice {\n                  amount\n                  currencyCode\n                }\n              }\n              options {\n                name\n                optionValues {\n                  name\n                  swatch {\n                    color\n                    image {\n                      previewImage {\n                        url\n                      }\n                    }\n                  }\n                }\n              }\n              images(first: 10) {\n                nodes {\n                  url\n                  altText\n                  width\n                  height\n                }\n              }\n              variants(first: 10) {\n                nodes {\n                  id\n                  title\n                  availableForSale\n                  selectedOptions {\n                    name\n                    value\n                  }\n                  image {\n                    url\n                    altText\n                  }\n                  price {\n                    amount\n                    currencyCode\n                  }\n                }\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: ExpertChosenProductsQuery;
    variables: ExpertChosenProductsQueryVariables;
  };
  ...
  '#graphql\n  fragment Collection on Collection {\n    id\n    title\n    handle\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n    products(first: 250) {\n      nodes {\n        id\n      }\n    }\n  }\n\n  query CollectionsPageQuery(\n    $country: CountryCode\n    $endCursor: String\n    $first: Int\n    $language: LanguageCode\n    $last: Int\n    $startCursor: String\n  ) @inContext(country: $country, language: $language) {\n    collections(\n      first: $first,\n      last: $last,\n      before: $startCursor,\n      after: $endCursor\n    ) {\n      nodes {\n        ...Collection\n      }\n      pageInfo {\n        hasNextPage\n        hasPreviousPage\n        startCursor\n        endCursor\n      }\n    }\n  }\n': {
    return: CollectionsPageQueryQuery;
    variables: CollectionsPageQueryQueryVariables;
  };
