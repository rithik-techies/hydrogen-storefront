        ...
        <div className="relative flex flex-col sm:items-end justify-between mb-12 lg:mb-14 text-neutral-900 dark:text-neutral-50">
          ...
          <div className="relative md:mb-16 max-w-2xl mx-auto">
             <div className="flex justify-center mb-4">
              ...
              <img class="opacity-50 md:opacity-100 absolute -mr-16 lg:mr-3 right-full top-1" src="https://cdn.shopify.com/oxygen-v2/32559/21434/44377/1498188/assets/quotation-0X_P_9xw.png" width="50" alt="quotation" sizes="50px"></img>
              <img class="opacity-50 md:opacity-100 absolute -mr-16 lg:mr-3 left-full top-1" src="https://cdn.shopify.com/oxygen-v2/32559/21434/44377/1498188/assets/quotation2-Uv0pj8F-.png" width="50" alt="quotation" sizes="50px"></img>
            ...
            <div className="flex flex-col items-center justify-center mb-6 sm:mb-8">
              ...
              <div className="flex items-center space-x-0.5 mt-3.5 text-yellow-500">
                {[...Array(testimonials[currentIndex].rating)].map((_, i) => (
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" class="w-6 h-6"><path fill-rule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" clip-rule="evenodd"></path></svg>
                ))}
              </div>
            </div>
